...
/** Figma: текст «Black Russia» — Montserrat Black 900, 18px, #FFFFFF */
...
/**
 * Figma Rectangle 87: 103.36×115.24, right 18.42, top −14.63.
 * В CSS rotate(+33.11deg) совпадает с макетом (Figma −33.11° против часовой).
 */
