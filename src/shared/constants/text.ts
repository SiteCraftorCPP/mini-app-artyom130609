...
export const PAYMENT_TEXT = {
  ...
  /** Курс по ТЗ: 1 ₽ = 6,9 ₸; 100 ₽ ≈ 690 ₸ после округления */
  kztRateLine: "Курс: 1 ₽ = 6,9 ₸ · примерно: 100 ₽ ≈ 690 ₸",
  kztAmountDueLine: "Сумма к оплате",
  kztGoToBotBody:
    "Чтобы продолжить оформление заказа, выйдите из магазина и перейдите в бота.",
  kztGoToBotButton: "Перейти к боту",
  paymentMinSbp: (min: number) =>
...
export const VIRT_SELL_TEXT = {
  description:
    "Нажмите «Продать» — откроется чат с менеджером для продажи виртов",
