...
const inputVariants = {
  ...
  form: {
    input:
      "h-full w-full rounded-full bg-transparent pl-5 pr-4 pt-[2px] text-[14px] leading-[100%] font-normal text-black transition-colors placeholder:text-[14px] placeholder:font-medium placeholder:text-white/60 focus-visible:outline-hidden disabled:cursor-not-allowed disabled:opacity-50 ",
